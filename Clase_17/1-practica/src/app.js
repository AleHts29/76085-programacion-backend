...
const connectMongoDB = async () => {
    try {
        ...
        // console.log("dataOrders: ", dataOrders.default);

        // let result = await ordersModel.insertMany(dataOrders.default)
        // let result = await ordersModel.insertMany(
        //     {
        //         name: "Vegan", price: 18, quantity: 10, date: "2021-01-13T05:10:13Z"
        //     }
        // )
        // console.log("Se insertaron los pedidos correctamente: ", result)


        // Definicion de la funcion de agregacion
        let size = "small"
